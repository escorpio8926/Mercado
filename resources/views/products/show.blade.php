@extends('layouts.app')
@section('title','Dashboard | Tucu-Mercado')
...
<div class="text-center">
	...
	<i class="material-icons">add</i> Añadir al Carro de Compras
</button>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Seleccione la cantidad que desea agregar del Producto</h4>
      </div>
